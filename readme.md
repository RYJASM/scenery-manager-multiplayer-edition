...
- **Placement order**: Controls the visual order in which elements are placed. **Default** places elements in the order they were copied (incremental). **Radial** places elements outward from the center of the selection. **Spiral** places elements in an outward spiral. **Random** places elements in a randomized order. Combined with the placement delay, this controls how the scenery appears on screen as it is being placed.
